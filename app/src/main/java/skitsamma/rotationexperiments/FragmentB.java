...
public class FragmentB extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            ...
            explicitlySavedObjectForCreate = "Fragment A's explicity saved Object for the creation";
        } else {
        ...
        implicitlySavedPrimitiveObject = "Fragment B's implicitly saved primitive object";
        implicitlySavedComplexObject = new ComplexObject("Fragment B");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(savedInstanceState == null) {
            ...
            explicitlySavedObjectForView = "Fragment B's explicity saved Object for the view";
        } else {
