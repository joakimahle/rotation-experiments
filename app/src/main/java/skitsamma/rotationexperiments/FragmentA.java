...
public class FragmentA extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        implicitlySavedPrimitiveObject = "Fragment A's implicitly saved primitive object";
        implicitlySavedComplexObject = new ComplexObject("Fragment A");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(savedInstanceState == null) {
            ...
            explicitlySavedObjectForView = "Fragment A's explicity saved Object for the view";
        } else {
